...
class OffsetsFirmware_672:
    ...
    # 0xffffffff826c52aa : add rsp, 0x28 ; ret
    ADD_RSP_28_POP_RBP_RET = 0xffffffff826ed57f
    ...
    # 0xffffffff825272c9 : pop r8 ; ret
    POP_R8_POP_RBP_RET = 0xffffffff825272c9
    ...
    # 0xffffffff8249b03c Changed To : mov rdi, qword ptr [rdi] ; jmp rax
    MOV_RDI_QWORD_PTR_RDI_POP_RBP_JMP_RAX = 0xffffffff8249b03c
    ...
    # 0xffffffff824a8427 Changed To : sub rsi, rdx ; mov rax, rsi ; ret
    SUB_RSI_RDX_MOV_RAX_RSI_POP_RBP_RET = 0xffffffff824a8427
